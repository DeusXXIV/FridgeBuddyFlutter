...
GoRouter createAppRouter(String? householdId) {
  ...
  return GoRouter(
    initialLocation: hasHousehold ? '/home' : '/',
    routes: [
      // ------------------
      // ONBOARDING FLOW
      // ------------------
      GoRoute(
        ...
        builder: (context, state) {
          // If household already exists, jump to home
          if (hasHousehold) return const HomeTabWrapper();
      ...
      GoRoute(
        ...
        builder: (context, state) {
          if (hasHousehold) return const HomeTabWrapper();
          return const HouseholdSelectScreen();
        },
      ),
      GoRoute(
